...
st.write("""
         **:green[Welcome to Money Matters!]** Here, we hope to help you take charge of your financial destiny 
         ...
         - With the **:green[analyze]** page, you can paste in any financial statement or company press release and we will summarize it and assess whether or not the company would be a good investment right now.
