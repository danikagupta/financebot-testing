...
st.write("""
         **:green[Welcome to Money Matters!]** Here, we hope to help you take charge of your financial destiny 
         ...
         - With the **ask** page, you can ask our Chat-GPT-based AI any burning finance questions you have.
         - With the **learn** page you can quiz yourself on personal finance basics.
         - With the **analyze** page you can paste in any financial statement or company press release and we will summarize it and assess whether or not the company would be a good investment right now.
